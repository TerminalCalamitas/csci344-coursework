...
def get_all_posts():
    ...
    posts = Post.query.filter_by(user_id=9).all()
    for post in posts:
        print(post.caption)
    return posts
...
def create_user():
    user = User(
        ...
        last_name='Parkzer',
        username='aparkzer',
        email='parkzer@dougdoug.com'
    )
    user.password_plaintext = 'youareliterallytrolling'
    user.set_password('youareliterallytrolling')
