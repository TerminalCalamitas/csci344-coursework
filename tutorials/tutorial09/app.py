...
@app.route('/message')
def exercise1():
    return f"Hello {current_user.get("first_name")} {current_user.get("last_name")}!"
...
def exercise3():
    ...
    if (search_term == None and location == None):
        return "Please include term and location in your query"
    if (search_term == None):
        return "Please include term in your query"
    if (location == None):
        return "Please include location in your query"
    count = 10
